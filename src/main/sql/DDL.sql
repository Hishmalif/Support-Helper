...
create index ix_blacklist_userid on public.blacklist(user_id);
create index ix_blacklist_unlockdate on public.blacklist(unlock_date);
...
create index ix_user_data_userid on public.user_data(user_id);
...
create index ix_user_usage_userid on metrics.user_usage(user_id);
create index ix_user_usage_commandid on metrics.user_usage(command_id);
create index ix_user_usage_usagedate on metrics.user_usage(usage_date);